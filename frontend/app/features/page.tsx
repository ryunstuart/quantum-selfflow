    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white flex flex-col">
      <nav className="border-b border-white/10 bg-black/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/features" className="text-cyan-400 font-medium">Features</Link>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 flex-1">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tighter mb-6">Powerful Features</h1>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">Built specifically for self-insured employers and mid-market TPAs</p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-10">
            <div className="text-5xl mb-6">📍</div>
            <h3 className="text-2xl font-semibold mb-4">Real-Time ZIP Checker</h3>
            <p className="text-slate-400">Instant network adequacy scoring for any ZIP code. Know exactly how strong your coverage is before a claim happens.</p>
          </div>

          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-10">
            <div className="text-5xl mb-6">📊</div>
            <h3 className="text-2xl font-semibold mb-4">Live Savings Dashboard</h3>
            <p className="text-slate-400">Track savings in real time, see claims activity, and monitor network utilization with beautiful visuals.</p>
          </div>

          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-10">
            <div className="text-5xl mb-6">🛡️</div>
            <h3 className="text-2xl font-semibold mb-4">Sentinel AI Steering</h3>
            <p className="text-slate-400">AI-powered claim steering that automatically routes employees to the best providers — saving money without sacrificing care.</p>
          </div>

          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-10">
            <div className="text-5xl mb-6">🔗</div>
            <h3 className="text-2xl font-semibold mb-4">TPA White-Label</h3>
            <p className="text-slate-400">Regional TPAs can offer Quantum SelfFlow under their own brand with full backend access and reporting.</p>
          </div>
        </div>
